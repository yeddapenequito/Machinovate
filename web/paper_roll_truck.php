				...
				<div class="col-sm-8">
					...
					<div id="description">
						<p class="text-justify">
							 Reel/Paper Roll Pallet Truck for hold roller for handing cylindrical loads where the lifting operation is achieved without pallets. Cylindrical loads can be lifted directly from the floor, and transported.	
						</p>
					</div>
