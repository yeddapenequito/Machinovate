...
CREATE TABLE slitter (
	...
	Cutting_Standard VARCHAR(20) NOT NULL,
	Cutting_Additional_CB VARCHAR(20) NULL,
	Cutting_AddtlBlade TINYINT(2) UNSIGNED NULL DEFAULT 0,
	Cutting_CoreCutterMachine VARCHAR(20) NULL,
	
	URS_HydraulicShaftless VARCHAR(20) NULL,
